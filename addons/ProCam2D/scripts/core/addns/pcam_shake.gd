...
# Exported properties
export(Preset) var preset = Preset.CUSTOM setget set_preset
export(float, 0, 100) var speed = 15.0
export(float, 0, 100) var intensity = 10.0
export(int, FLAGS, "Vertical", "Horizontal", "Random", "Perlin", "Rotate", "Circular", "Zoom") var shake_type = 0
export(float, 0, 10) var trauma_attack = 0.0  # New parameter for fade-in
export(float, 0, 10) var trauma_decay = 0.8
export(float, 0, 10) var duration = 0.5
export(bool) var endless = false

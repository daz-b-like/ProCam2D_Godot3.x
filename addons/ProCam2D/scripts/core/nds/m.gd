...
var magnet_shape = MagnetShape.CIRCLE setget set_magnet_shape
var attract_repel = AttractRepel.ATTRACT setget set_attract_repel
var radius: float = 200.0 setget set_radius
var rectangle_size: Vector2 = Vector2(400, 200) setget set_rectangle_size
var use_full_force: bool = true setget set_use_full_force
var force: Vector2 = Vector2(100.0, 100.0) setget set_force
var falloff_curve: Curve setget set_falloff_curve

...
var zoom_shape = ZoomShape.CIRCLE setget set_zoom_shape
var radius = 200.0 setget set_radius
var rectangle_size = Vector2(400, 200) setget set_rectangle_size
var zoom_factor = 1.5 setget set_zoom_factor
var gradual_zoom = true setget set_gradual_zoom
